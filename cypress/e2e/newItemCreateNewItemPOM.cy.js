...
import MulticonfigurationPage from "../pageObjects/MulticonfigurationPage";
...
describe("US_00.000 | New Item > Create New item", () => {
  ...
  it.only("RF_00.000.16 | User can see new item name on dashboard after Save button is clicked", () => {
